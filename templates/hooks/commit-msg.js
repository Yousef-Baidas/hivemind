...
const re = new RegExp(`^(${types})(\\([a-z0-9._/-]+\\))?!?: [a-z][^\\n]*$`);
...
const banned = /^(Co-Authored-By|Co-authored-by|Generated with|Generated-by|Assisted-by|Signed-off-by: .*(claude|anthropic|ai)|🤖)/im;
